...
public View onCreateView(LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
    ...
    MocUserManager userManager = new MocUserManager();
    CommunityListAdapter communityListAdapter = new CommunityListAdapter(communityView.getContext(),userManager.getUsers());
